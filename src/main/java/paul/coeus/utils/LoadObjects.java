...
public class LoadObjects {
    ...
    public static Mesh reorderLists(List<Vector3f> posList, List<Vector2f> textCoordList,  List<Vector3f> normList, List<Face> facesList) {
        ...
        Mesh mesh = new Mesh(posArr, textCoordArr, indicesArr,normArr, null);
        return mesh;
    }
